...
<div class="container mt-3">
    <!-- Tampilkan notifikasi jika OTP valid atau error -->
    @if(session('success'))
    ...
    <form action="{{ route('perawat-profil.changePassword') }}" method="POST">
        @csrf
        <div class="mb-2">
...
<!-- CSS untuk menyembunyikan ikon show password bawaan browser -->
<style>
