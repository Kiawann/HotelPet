...
<div class="container mt-4">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-3 mt-4">
        ...
        <div class="col">
            <a href="{{ route('kasir-reservasi-hotel.index', ['status' => 'di pesan', 'date_filter' => 'today']) }}" class="text-decoration-none">
        ...
        <div class="col">
            <a href="{{ route('kasir-reservasi-hotel.index', ['status' => 'check in', 'date_filter' => 'today'])}}" class="text-decoration-none">
                <div class="card bg-success text-white h-100 shadow-sm" style="height: 150px;">
                    <div class="card-body d-flex flex-column justify-content-between">
        ...
        <div class="col">
            <a href="{{ route('kasir-reservasi-hotel.index', ['status' => 'di bayar', 'date_filter' => 'today']) }}" class="text-decoration-none">
                <div class="card bg-info text-white h-100 shadow-sm" style="height: 150px;">
                    <div class="card-body d-flex flex-column justify-content-between">
        ...
        <div class="col">
            <a href="{{ route('kasir-reservasi-hotel.index', ['status' => 'check out', 'date_filter' => 'today']) }}" class="text-decoration-none">
                <div class="card bg-warning text-white h-100 shadow-sm" style="height: 150px;">
                    <div class="card-body d-flex flex-column justify-content-between">
        ...
        <div class="col">
            <a href="{{ route('kasir-reservasi-hotel.index', ['status' => 'cancel', 'date_filter' => 'today']) }}" class="text-decoration-none">
                <div class="card bg-danger text-white h-100 shadow-sm" style="height: 150px;">
                    <div class="card-body d-flex flex-column justify-content-between">
