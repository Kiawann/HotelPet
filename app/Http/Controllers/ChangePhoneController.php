...
class ChangePhoneController extends Controller
{
    public function changePhone(Request $request)
    {
        ...
        try {
            ...
            return ($user->role === 'user')
                ? redirect()->route('validate-otp-show')->with('success', 'Kode OTP telah dikirim.')
    ...
    public function validateOtp(Request $request)
    {
        ...
        if ($codeOtp && $codeOtp->otp == $otp) {
            ...
            if(Auth::user()->role === 'user') {
                return redirect()->route('profil.index')->with('success', 'Phone number updated successfully!');
            }
    ...
    public function showValidateOtpCustomer()
    {
        ...
        return view('user.verifikasi', compact('user', 'customer', 'member'));
    }
